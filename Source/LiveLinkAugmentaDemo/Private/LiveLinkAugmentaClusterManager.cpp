	...
	const TMap<FString, FString> EventData)
{
	...
	FString TmpString = *EventData.Find("Frame");	AugmentaObject.Frame = FCString::Atoi(*TmpString);
	TmpString = *EventData.Find("Id");	 AugmentaObject.Id = FCString::Atoi(*TmpString);
